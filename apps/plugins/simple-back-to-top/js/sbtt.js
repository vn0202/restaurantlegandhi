...
{
    jQuery("body").append('<div id="sbttBacktotop" style="border: 1px solid #ff9800; height: 40px; width: 40px; border-radius: 100%;display: flex; justify-content: center; align-items: center" class="sbttBacktotop"><svg width="24" height="24" viewBox="0 0 24 24" style="fill:#880021" xmlns="//www.w3.org/2000/svg">\n' +
